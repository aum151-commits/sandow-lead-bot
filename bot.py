...
LANDINGS = {
    "boks": ("лендинг Бокс",
             ...
             "боксом бесплатное. А ещё сейчас можно забрать год в подарок."),
    "kik": ("лендинг Кикбоксинг",
            "Интересует кикбоксинг? В «Сандов Фитнес» он есть и в группах по "
            "расписанию, и персонально с тренером. А ещё сейчас можно забрать "
            "год в подарок."),
    "zal": ("лендинг Тренажёрный зал",
            ...
            "И сейчас можно забрать год в подарок."),
    "noch": ("лендинг Круглосуточный фитнес",
             ...
             "начните с подарка — сейчас можно забрать год в подарок."),
    "boec": ("лендинг Бойцовский клуб",
             ...
             "занятие боксом бесплатное, и сейчас можно забрать год в подарок."),
}
...
def step_hello(chat_id, message_id=None):
    text = (
        "<b>Получи год в подарок.</b> «Сандов Фитнес» — это 2500 м²: тренажёрный "
...
def step_phone(chat_id, message_id, goal, direction):
    ...
    api("sendMessage", chat_id=chat_id, parse_mode="HTML",
        text=(body +
              "🎁 <b>Год в подарок</b> — забирайте.\n\n"
              "Чтобы менеджер с вами связался — нажмите кнопку внизу или напишите номер.\n\n"
...
def step_combat(chat_id, message_id=None):
    ...
    api("sendMessage", chat_id=chat_id, parse_mode="HTML",
        text=("🎁 <b>Первая тренировка по боксу — бесплатная</b>. И сейчас можно "
              "забрать год в подарок.\n\n"
...
VERSION = "2026-09-25-v14-god-v-podarok"
